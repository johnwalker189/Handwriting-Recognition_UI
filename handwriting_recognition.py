...
class HandwritingRecognitionFrame(ctk.CTkFrame):
    def __init__(self, container):
        ...
        self.hand_rec_image = ctk.CTkImage(Image.open(self.image_path + r'\hand_predict.png'), size=(20,20))
        self.hand_predict_button = ctk.CTkImage(Image.open(self.image_path + r'\hand_predict_button.png'), size=(20,20))
        self.reset_button = ctk.CTkImage(Image.open(self.image_path + r'\reset.png'), size=(20,20))
        ...
        self.canvas_label = ctk.CTkLabel(master=self.canvas_frame, text='', width=400, height=200)
        ...
        self.hand_predict_button = ctk.CTkButton(master=self.prediction_frame, text='Predict',
                                                 image=self.hand_predict_button,
                                                **self.button_setting)
        ...
        self.messagebox = ctk.CTkTextbox(master=self.second_row, corner_radius=15, border_width=0, 
                                         font=('Ariel', 15, 'bold'),
                                         fg_color='#767676')
        self.messagebox.insert(tk.INSERT, 'LOG BOX\n')
        self.messagebox.configure(state='disabled')
        self.messagebox.grid(row=0,column=0,sticky='nsew', padx=10, pady=10)
    ...
    def on_upload_image(self):
        ...
        self.uploaded_image = ctk.CTkImage(Image.open(self.filename), size=(500,400))
